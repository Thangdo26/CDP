 ...
 * ━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
 *
 * Infrastructure layer representation of Profile entity.
 * Maps to Elasticsearch index.
 *
 * DDD Pattern: This is INFRASTRUCTURE MODEL
 * - Used ONLY in infrastructure layer
 * - Mapped to/from Domain entity via ProfileMapper
 * - Contains ES-specific annotations
 * ━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
 */
@Data
...
public class ProfileDocument {
    ...
    /**
     * Profile status: active | merged | deleted
     * Default: active
     *
     * - active: Profile can be merged, searchable
     * - merged: Profile merged into master, excluded from duplicate detection
     * - deleted: Soft deleted, excluded from searches
     */
     ...
     */
    @Field(type = FieldType.Date, name = "merged_at",
