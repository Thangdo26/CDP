...
public interface ProfileRepository {
    ...
    /**
     * Add user to profile atomically using ES script
     */
    void addUserAtomic(String profileId, String appId, String userId);

    /**
     * Remove user from profile atomically
     */
    void removeUserAtomic(String profileId, String appId, String userId);
}