...
public class ProfileCacheConfig {
     ...
     *
     * CONFIGURATION:
     * - profiles-hot: 60,000 entries, 15 min TTL
     ...
     *
     * CONFIGURATION:
     * - profiles-hot: 60 min TTL
     * - master-profiles: 60 min TTL (longer - less changes)
     * - profiles-search: 60 min TTL
     */
    @Bean
    public CacheManager redisCacheManager(RedisConnectionFactory connectionFactory) {
        ...
        RedisCacheConfiguration defaultConfig = RedisCacheConfiguration
                .defaultCacheConfig()
                .entryTtl(Duration.ofMinutes(60))  // Default 60 min
                .serializeKeysWith(
        ...
        // Individual profiles: 60 min (default)
        ...
        // Search results: 60 min (searches change frequently)
     ...
     *
     * profiles-hot (Individual Profiles):
     * - L1: 60K entries, 15 min TTL
     * - L2: Unlimited, 60 min TTL
