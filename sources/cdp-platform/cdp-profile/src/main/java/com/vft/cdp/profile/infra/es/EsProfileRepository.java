...
public class EsProfileRepository implements ProfileRepository {
    ...
    public Page<EnrichedProfile> search(SearchProfileRequest request) {
        ...
        log.info("━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━");
        log.info("🔍 ENHANCED SEARCH PROFILES");
        log.info("━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━");
        log.info("  Tenant ID: {}", request.getTenantId());
        log.info("  User ID: {}", request.getUserId());
        log.info("  App ID: {}", request.getAppId());
        log.info("  Type: {}", request.getType());
        log.info("  Traits: {}", request.getTraits());
        log.info("  Page: {}, Size: {}", request.getPage(), request.getPageSize());
        log.info("━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━");
