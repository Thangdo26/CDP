 ...
 * Represents the master profile that consolidates multiple merged profiles
 * ━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
 */
@Data
@NoArgsConstructor
@AllArgsConstructor
@Builder
@Document(indexName = "master_profiles_thang_dev")
public class MasterProfileDocument {

    @Id
    private String id;  // tenant_id|app_id|master_id
    ...
    @Field(type = FieldType.Keyword, name = "master_id")
    ...
    @Field(type = FieldType.Keyword, name = "merged_profile_ids")
    private List<String> mergedProfileIds;

    @Field(type = FieldType.Integer, name = "merge_count")
    ...
    // ━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
    // INNER CLASSES (Same structure as ProfileDocument)
    // ━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
